...
interface TrainerBasicInfoFormProps {
  formData: any;
  updateFormData: (data: any) => void;
  onNext: () => void;
}

const TrainerBasicInfoForm = ({ formData, updateFormData, onNext }: TrainerBasicInfoFormProps) => {
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-center">Create Your Trainer Account</h2>
